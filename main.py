...
class Accounting_management:
    ...
    def interface(self):
        ...
        heading=Label(root,text='Computerized Accounting Project', bg="powder blue", font=("Arial",16),bd=50)
        heading.pack()

        label=Label(root,text='Submitted to Prof Farhan AHMED Siddiqui',bg = "powder blue", bd = 50, fg = "black", font = ("Castellar",17))
        label.pack()

        stud1=Label(root,text='Yaseen Zubair: B18158065', bg="powder blue",bd=5,fg="black",font=('Arial',10))
        stud1.pack()

        
        stud2=Label(root,text='Shaaf Ejaz: B18158040', bg="powder blue",bd=5,fg="black",font=('Arial',10))
        stud2.pack()

        
        stud3=Label(root,text='Syed Hamza Munawwer: B18158053', bg="powder blue",bd=5,fg="black",font=('Arial',10))
        stud3.pack()
        ...
        x = Label(root, text="Yaseen", font='Helvetica 14', height=3, width=100, fg="steel blue",bg="powder blue").place(x=500,y=650)
        window_height = 550
    ...
    def export(self):
        ...
        print("Export Done, Program Running ")
